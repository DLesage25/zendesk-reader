...
var DatePicker = function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _this.renderDateInput = function () {
      ...
      var className = classnames(_this.props.className, (_classnames = {}, _classnames[inputBoxClassName] = _this.state, _classnames));

      console.log(_this.state)

      var customInput = _this.props.customInput || React.createElement("input", { type: "text", onKeyPress: (event) => {event.preventDefault();} });
