				    ...
				    <div className="card-header">
				        <span className="cat__core__title card-title" style={{ fontSize: '18px' }}>
				        	<div style={{ float: 'left'}}>
					            ...
					            <Dropdown current={globalDate} options={dateList} action={changeGlobalDate} buttonClassName="btn btn-sm btn-outline-secondary ml-2 dropdown-toggle"/>
				            </div>
							...
							<button type="button" className="btn btn-sm ml-2 btn-outline-primary" onClick={() => this.props.refreshData()} > <i className="fa fa-sync-alt" style={{ color:"#007bff" }}/> </button>
				            </div>
				        </span>
				    </div>
