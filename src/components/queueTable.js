              ...
              <div>
                  { !this.props.data ? <p> Loading </p> :
                    <div>
                      ...
                      />
                      <CSVLink data={this.props.data} filename={'Queue_Volume_Report_' + moment().format('MM_DD_YYYY_hh_mm') + '.csv'} className="btn btn-secondary drilldown-download">Download</CSVLink>
                    </div>
                  }
              </div>
    )
